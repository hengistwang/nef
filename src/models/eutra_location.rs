...
pub struct EutraLocation {
    ...
    #[serde(rename = "globalNgenbId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub global_ngenb_id: Option<Option<Box<crate::models::GlobalRanNodeId>>>,
    #[serde(rename = "globalENbId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub global_enb_id: Option<Option<Box<crate::models::GlobalRanNodeId>>>,
}

impl EutraLocation {
    /// Contains the E-UTRA user location.
    pub fn new(tai: crate::models::Tai, ecgi: crate::models::Ecgi) -> EutraLocation {
        EutraLocation {
            tai: Box::new(tai),
            ignore_tai: None,
            ecgi: Box::new(ecgi),
